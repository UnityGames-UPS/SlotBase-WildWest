...
public class JSFunctCalls : MonoBehaviour
{
  ...
  /// <summary>Self-contained resize bridge: the page drives OC.SwitchDisplay("width,height") on its own resize.</summary>
  ...
  /// <summary>Inbound auth: routes the host's "TokenReceived" message to gameObjectName.methodName(json).</summary>
